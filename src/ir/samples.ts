...
const login: Sample = {
  ...
  ir: {
    ...
    nodes: [
      ...
      // Divider
      node('node_18', 'container', 'node_2', 9, 'flex items-center gap-3 text-[10px] uppercase tracking-wide text-slate-500', 'clause_7'),
...
const pricing: Sample = {
  ...
  ir: {
    ...
    nodes: [
      ...
      node('node_21', 'text', 'node_4', 12, 'text-center text-xs text-slate-500', 'clause_8', 'No credit card required · cancel anytime'),
...
const dashboard: Sample = {
  ...
  ir: {
    ...
    nodes: [
      ...
      node('node_10', 'text', 'node_9', 0, 'text-xs font-medium uppercase tracking-wide text-slate-500', 'clause_6', 'Revenue'),
      ...
      node('node_13', 'text', 'node_12', 0, 'text-xs font-medium uppercase tracking-wide text-slate-500', 'clause_6', 'Active users'),
      ...
      node('node_16', 'text', 'node_15', 0, 'text-xs font-medium uppercase tracking-wide text-slate-500', 'clause_6', 'Churn'),
      ...
      node('node_31', 'text', 'node_29', 1, 'text-xs text-slate-500', 'clause_9', 'Last 6 months'),
...
const analytics: Sample = {
  ...
  ir: {
    ...
    nodes: [
      ...
      node('node_15', 'text', 'node_13', 1, 'text-[11px] text-slate-500', 'clause_6', 'ada@northwind.io'),
      ...
      node('node_26', 'text', 'node_25', 0, 'text-xs font-medium uppercase tracking-wide text-slate-500', 'clause_14', 'Revenue'),
      ...
      node('node_30', 'text', 'node_29', 0, 'text-xs font-medium uppercase tracking-wide text-slate-500', 'clause_14', 'Active users'),
      ...
      node('node_34', 'text', 'node_33', 0, 'text-xs font-medium uppercase tracking-wide text-slate-500', 'clause_14', 'Conversion'),
      ...
      node('node_38', 'text', 'node_37', 0, 'text-xs font-medium uppercase tracking-wide text-slate-500', 'clause_14', 'Churn'),
      ...
      node('node_45', 'text', 'node_43', 1, 'text-xs text-slate-500', 'clause_18', 'Last 6 months'),
